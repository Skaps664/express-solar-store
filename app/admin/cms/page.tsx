            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                <Button variant="outline" size="sm" asChild>
                  <a href="http://localhost:3333/structure/homePageContent;d70b1c61-6194-4670-bfbc-894891aece82" target="_blank" rel="noopener noreferrer">
                    <FileText className="mr-2 h-3 w-3" />
                    Home Heading Content
                  </a>
                </Button>
                <Button variant="outline" size="sm" asChild>
                  <a href="http://localhost:3333/structure/homePageAds;ab91d5cf-0b39-4594-8f53-b74239cc5b94" target="_blank" rel="noopener noreferrer">
                    <Globe className="mr-2 h-3 w-3" />
                    Home Ads
                  </a>
                </Button>
                <Button variant="outline" size="sm" asChild>
                  <a href="http://localhost:3333/structure/homePageBanner;09a86969-235c-4a72-8ad8-cd0eeb2ba35f" target="_blank" rel="noopener noreferrer">
                    <FileText className="mr-2 h-3 w-3" />
                    Home Banner
                  </a>
                </Button>
                <Button variant="outline" size="sm" asChild>
                  <a href="http://localhost:3333/structure/solarExpressBannerOne;25d7741d-26b0-4b07-b2c3-f8d8f2e57a71" target="_blank" rel="noopener noreferrer">
